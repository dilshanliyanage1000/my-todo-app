            ...
            <div className="col-lg-5 bottom-col " style={{padding:"0px"}}>
                <div className="blogos row ">
                    <a href="# " style={{marginLeft:"auto"}}>
                        <img src={KuppiyaVODImg} className="logo " alt="KuppiyaVODImg " />
                    </a>
                    <a href="# ">
                        <img src={KuppiyaLiveImg} className="logo " alt="KuppiyaLiveImg " />
                    </a>
                    <a href="# ">
                        <img src={KuppiyaStoreImg} className="logo " alt="KuppiyaStoreImg " />
                    </a>
                    <a href="# ">
                        <img src={TutionHandiyaImg} className="logo " alt="TutionHandiyaImg " />
                    </a>
                    <a href="# ">
                        <img src={SquadEkaImg} className="logo " alt="SquadEkaImg " />
                    </a>
                    <a href="# " style={{marginRight: "auto"}}>
                        <img src={AfterAlsImg} className="logo " alt="AfterAlsImg " />
                    </a>
